...
import { IonContent, IonPage, IonButton, IonToast, useIonViewWillEnter } from '@ionic/react';
...
const MoodSelector: React.FC = () => {
	...
	const handleConfirm = async () => {
		if (selectedMood) {
			try {
				...
				setToastMessage('Estado de ánimo registrado exitosamente');
				...
				setToastMessage('Error al guardar. Intenta nuevamente');
	...
	const selectedEmoji = selectedMood ? MOOD_EMOJIS.find(e => e.id === selectedMood) : null;
				...
				<IonContent className='mood-selector-content'>
					<div className='confirmation-container'>
						...
						<div className='confirmation-actions'>
							<IonButton className='confirm-button' expand='block' onClick={handleConfirm}>
								Confirmar
							</IonButton>
							<IonButton className='cancel-button' expand='block' fill='clear' onClick={handleCancel}>
								Cancelar
							</IonButton>
						</div>
					</div>
				...
				<div className='mood-selector-container'>
					...
					<div className='mood-grid'>
						{MOOD_EMOJIS.map(mood => (
							<button key={mood.id} className='mood-option' onClick={() => handleMoodSelect(mood.id)}>
